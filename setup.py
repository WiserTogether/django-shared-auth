...
if root_dir != '':
    os.chdir(root_dir)
extensions_dir = 'django_shared_auth'
...
version = __import__('django_shared_auth').__version__

setup(
    name='django-shared-auth',
    version=version,
    description='Shared Authentication for Django',
    long_description="""django-shared-auth implements a simple cookie-based shared
    authentication scheme for django sites. See the README for more details.
    """,
    author='Erik LaBianca',
    author_email='erik.labianca@gmail.com',
    url='http://github.com/easel/django-shared-auth',
